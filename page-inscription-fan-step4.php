<?php
/**
 * Template Name: Inscription Fan - Étape 4
    ...
    <main class="auth-content">
        <div class="auth-container">
            <div class="auth-frame">
                ...
                <h1 class="auth-title">Ton inscription est finie cher fan !</h1>
                ...
                <a href="<?php echo esc_url(home_url('/')); ?>" class="auth-submit-btn">Suivant</a>
            </div>
        </div>
    </main>
