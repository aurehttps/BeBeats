        ...
        <section class="events-list">
            ...
            <article class="event-card">
                <div class="event-image">
                    <img src="../Images/event-firewood.jpg" alt="Firew00d">
                </div>
            ...
            <article class="event-card">
                <div class="event-image">
                    <img src="../Images/event-bobby-watson.jpg" alt="Bobby Watson">
                </div>
                <div class="event-details">
            ...
            <article class="event-card">
                <div class="event-image">
                    <img src="../Images/event-pretty-much-average.jpg" alt="Pretty Much Average">
                </div>
                <div class="event-details">
            ...
            <article class="event-card">
                <div class="event-image">
                    <img src="../Images/event-iamwill.jpg" alt="IAMWILL">
                </div>
                <div class="event-details">
