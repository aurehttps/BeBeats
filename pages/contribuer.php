...
<head>
    ...
    <title>BeBeats - Contribuer</title>
    
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">

    <link rel="stylesheet" href="../styles.css">
    <link rel="stylesheet" href="../css/pages/contribuer.css">
</head>
<body>
    <header>
    ...
    <nav class="main-nav" aria-label="Navigation principale">
        ...
        <a href="contribuer.php" class="nav-item active" aria-label="Contribuer">
        ...
        <a href="event.php" class="nav-item" aria-label="Event">
    ...
    <main class="main-content">
        <div class="contribuer-panel glassmorphism">
            ...
            <div class="content-area">
                <!-- Zone centrale vide pour le contenu -->
            </div>

            <!-- Right Side Menu -->
            <aside class="side-menu">
                <button class="menu-item menu-item-description" aria-label="Ajouter une description">
                    ...
                    <span class="menu-label">Ajouter une description</span>
                </button>
                
                <button class="menu-item" aria-label="Identifier une personne">
                    <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                ...
                <button class="menu-item menu-item-media" aria-label="Contenu multimédia">
                    <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button class="menu-item menu-item-publish" aria-label="Publier">
                    <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <nav class="category-nav">
                <button class="category-tab active" data-category="fan-art">Fan-art</button>
                <button class="category-tab" data-category="audio">Audio</button>
                <button class="category-tab" data-category="post">Post</button>
            </nav>
        </div>
    </main>
    ...
    <!-- Contribuer Script -->
    <script src="../js/contribuer.js"></script>
</body>
</html>
