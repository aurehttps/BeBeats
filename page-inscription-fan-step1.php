<?php
/**
 * Template Name: Inscription Fan - Étape 1
 * Template pour la première étape d'inscription Fan
 */
        ...
        <div class="auth-container">
            <div class="auth-frame">
                <div class="auth-progress-bar">
                    <div class="auth-progress-bar-fill" style="width: 25%;"></div>
                </div>
                ...
                <form class="auth-form" method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                    <input type="hidden" name="action" value="bebeats_register_fan_step1">
                    <?php wp_nonce_field('bebeats_register_fan_step1_action', 'bebeats_register_fan_step1_nonce'); ?>
