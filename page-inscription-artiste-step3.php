<?php
/**
 * Template Name: Inscription Artiste - Étape 3
        ...
        <div class="auth-container">
            <div class="auth-frame">
                <div class="auth-progress-bar">
                    <div class="auth-progress-bar-fill" style="width: 60%;"></div>
                </div>
                
                <a href="<?php echo esc_url(home_url('/inscription-artiste-step2')); ?>" class="auth-back-btn" aria-label="Retour">
                ...
                <form class="auth-form" method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" enctype="multipart/form-data">
                    <input type="hidden" name="action" value="bebeats_register_artiste_step3">
                    <?php wp_nonce_field('bebeats_register_artiste_step3_action', 'bebeats_register_artiste_step3_nonce'); ?>
                    <?php 
