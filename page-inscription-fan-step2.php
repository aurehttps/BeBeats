<?php
/**
 * Template Name: Inscription Fan - Étape 2
    ...
    <main class="auth-content">
        <div class="auth-container">
            <div class="auth-frame">
                ...
                <p class="auth-instruction">Sélectionnes 2 styles musicaux dont tu aimerais découvrir de nouveaux artistes.</p>
                
                <form class="auth-form" method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                    <input type="hidden" name="action" value="bebeats_register_fan_step2">
                    <?php wp_nonce_field('bebeats_register_fan_step2_action', 'bebeats_register_fan_step2_nonce'); ?>
                    <?php 
                    ...
                    <div class="genres-error" id="genres-error" style="display: none;">
                        Veuillez sélectionner exactement 2 genres musicaux.
                    </div>
